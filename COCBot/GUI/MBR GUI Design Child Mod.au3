...
#include "MBR GUI Design Child Mod - Donate.au3"
...
$hGUI_MOD_TAB_ITEM2 = GUICtrlCreateTabItem(GetTranslated(600,55, "Switch Account && Profile Options"))
; this tab will be empty because it is only used to display a child GUI
$hGUI_MOD_TAB_ITEM3 = GUICtrlCreateTabItem("Donation Stats")
; this tab will be empty because it is only used to display a child GUI
