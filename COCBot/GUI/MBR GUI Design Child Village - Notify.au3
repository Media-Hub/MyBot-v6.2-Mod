...
$hGUI_NOTIFY_TAB_ITEM1 = GUICtrlCreateTabItem(GetTranslated(600,18,"PushBullet/Telegram"))
	...
	Local $x = 25, $y = 45
		...
		$chkAlertPBVBreak = GUICtrlCreateCheckbox(GetTranslated(619, 31, "Take a break"), $x + 210, $y, -1, -1)
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
		; Added by CDudz
		$chkAlertBuilderIdle = GUICtrlCreateCheckbox(GetTranslated(619, 39, "Builder Idle"), $x + 315, $y, -1, -1)
		_GUICtrlSetTip(-1, GetTranslated(619, 40, "Send an Alert when at least one builder is idle."))
		GUICtrlSetState(-1, $GUI_DISABLE)
		$y += 20
		...
		$chkAlertPBOtherDevice = GUICtrlCreateCheckbox(GetTranslated(619, 37, "Another device"), $x + 210, $y, -1, -1)
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
		$chkAlertTopGain = GUICtrlCreateCheckbox(GetTranslated(619, 41, "Top Gain Loot"), $x + 315, $y, -1, -1)
			_GUICtrlSetTip(-1, GetTranslated(619, 42, "Send an Alert when a Top Gain is achived."))
			GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlCreateGroup("", -99, -99, 1, 1)

;Periodic village stats and Searchcount Nofications.
$y += 20
		$chkSearchNotifyCount = GUICtrlCreateCheckbox(GetTranslated(619, 43, "Searchcount.  Increment:"), $x + 10, $y, -1, -1)
		_GUICtrlSetTip(-1, GetTranslated(619, 44, "Searchcount Notification every ____ searches.  If getting pushbullet errors or acting funny, increase increment.  "))
		GUICtrlSetState(-1, $GUI_DISABLE)
		$txtSearchNotifyCount = GUICtrlCreateInput("25", $x + 150, $y + 2, 30, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
		$txtTip = GetTranslated(619, 45, "Searchcount Notification every ____ searches.")
		_GUICtrlSetTip(-1, $txtTip)
		GUICtrlSetLimit(-1, 3)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$chkVillageStatIncrement = GUICtrlCreateCheckbox(GetTranslated(619, 46, "Stats.  Increment:"), $x + 210, $y, -1, -1)
		_GUICtrlSetTip(-1, GetTranslated(619, 47, "Send Village Stats every ____ attacks."))
		GUICtrlSetState(-1, $GUI_DISABLE)
		$txtVillageStatIncrement = GUICtrlCreateInput("5", $x + 313, $y + 2, 30, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
		$txtTip = GetTranslated(619, 48, "No. of attacks between stat updates.")
		_GUICtrlSetTip(-1, $txtTip)
		GUICtrlSetLimit(-1, 3)
		GUICtrlSetState(-1, $GUI_DISABLE)
$y += 20
		$chkAlertSmartUpgrade = GUICtrlCreateCheckbox(GetTranslated(619, 49, "SmartUpgrade"), $x + 10, $y, -1, -1)
		_GUICtrlSetTip(-1, GetTranslated(619, 50, "Send a notification after each upgrade done with SmartUpgrade"))
		GUICtrlSetState(-1, $GUI_DISABLE)
...
$hGUI_NOTIFY_TAB_ITEM2 = GUICtrlCreateTabItem(GetTranslated(600, 19, "Instructions"))
	Local $x = 25, $y = 45
		$lblgrppushbullet = GUICtrlCreateGroup(GetTranslated(620, 0, "Remote Control Functions"), $x - 20, $y - 20, 430, 334)
			...
			$y = 240
			$btnHelpPushBullet = GUICtrlCreateButton(GetTranslated(18, 135, "PushBullet HELP"), $x + 200, $y + 90, 100, 20)
				_GUICtrlSetTip(-1, GetTranslated(18, 136, "PushBullet HELP - All commands"))
				GUICtrlSetOnEvent(-1, "btnHelpPushBullet")
			$btnHelpTelegram = GUICtrlCreateButton(GetTranslated(18, 137, "Telegram HELP"), $x + 315, $y + 90, 100, 20)
				_GUICtrlSetTip(-1, GetTranslated(18, 138, "Telegram HELP - All commands"))
