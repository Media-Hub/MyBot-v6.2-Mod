...
$hGUI_ModOptions2_TAB_ITEM1 = GUICtrlCreateTabItem("Multi Accounts Option")
	...
	$grpProfiles = GUICtrlCreateGroup("Switch Profiles", $x - 25, $y - 25, 427, 85)
		$y -= 0
		$cmbProfile = GUICtrlCreateCombo("", $x - 15, $y + 1, 120, 18, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			$txtTip = "Use this to switch to a different profile" & @CRLF & "Your profiles can be found in" & ": " & @CRLF &  $sProfilePath
		...
		$txtVillageName = GUICtrlCreateInput("MyVillage", $x - 15, $y, 120, 20, BitOR($SS_CENTER, $ES_AUTOHSCROLL))
			...
			_GUICtrlSetTip(-1, "Your village/profile's name")
		...
		$btnDelete = GUICtrlCreateButton("", $x + 142, $y + 1, 22, 22)
			...
			GUICtrlSetState(-1, $GUI_SHOW)
			_GUICtrlSetTip(-1, "Delete Profile")
...
$hGUI_ModOptions2_TAB_ITEM2 = GUICtrlCreateTabItem("Switch Profile Option")
	...
	Local $xStart = 0, $yStart = 0
	Local $x = $xStart + 30, $y = $yStart + 50
	$grpGoldSwitch = GUICtrlCreateGroup("Gold Switch Profile Conditions", $x - 20, $y - 20, 420, 75) ;Gold Switch
		$chkGoldSwitchMax = GUICtrlCreateCheckbox("Switch To", $x - 10, $y - 5, -1, -1)
		...
		$cmbGoldMaxProfile = GUICtrlCreateCombo("", $x + 60, $y - 5, 75, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			_GUICtrlSetTip(-1, $txtTip)
		$lblGoldMax = GUICtrlCreateLabel("When Gold is Above", $x + 145, $y, -1, -1)
	...
	$y += 30
		$chkGoldSwitchMin = GUICtrlCreateCheckbox("Switch To", $x - 10, $y - 5, -1, -1)
		...
		$cmbGoldMinProfile = GUICtrlCreateCombo("", $x + 60, $y - 5, 75, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			$txtTip = "Select which profile to be switched to when conditions met"
			_GUICtrlSetTip(-1, $txtTip)
		$lblGoldMin = GUICtrlCreateLabel("When Gold is Below", $x + 145, $y, -1, -1)
	...
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$y += 48
	$grpElixirSwitch = GUICtrlCreateGroup("Elixir Switch Profile Conditions", $x - 20, $y - 20, 420, 75) ; Elixir Switch
		$chkElixirSwitchMax = GUICtrlCreateCheckbox("Switch To", $x - 10, $y - 5, -1, -1)
		...
		$cmbElixirMaxProfile = GUICtrlCreateCombo("", $x + 60, $y - 5, 75, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			$txtTip = "Select which profile to be switched to when conditions met"
			_GUICtrlSetTip(-1, $txtTip)
		$lblElixirMax = GUICtrlCreateLabel("When Elixir is Above", $x + 145, $y, -1, -1)
		$txtMaxElixirAmount = GUICtrlCreateInput("6000000", $x + 275, $y - 5, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetLimit(-1, 7)
	$y += 30
		$chkElixirSwitchMin = GUICtrlCreateCheckbox("Switch To", $x - 10, $y - 5, -1, -1)
		...
		$cmbElixirMinProfile = GUICtrlCreateCombo("", $x + 60, $y - 5, 75, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			$txtTip = "Select which profile to be switched to when conditions met"
			_GUICtrlSetTip(-1, $txtTip)
		$lblElixirMin = GUICtrlCreateLabel("When Elixir is Below", $x + 145, $y, -1, -1)
	...
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$y += 48
	$grpDESwitch = GUICtrlCreateGroup("Dark Elixir Switch Profile Conditions", $x - 20, $y - 20, 420, 75) ;DE Switch
		$chkDESwitchMax = GUICtrlCreateCheckbox("Switch To", $x - 10, $y - 5, -1, -1)
		...
		$cmbDEMaxProfile = GUICtrlCreateCombo("", $x + 60, $y - 5, 75, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			$txtTip = "Select which profile to be switched to when conditions met"
			_GUICtrlSetTip(-1, $txtTip)
		$lblDEMax = GUICtrlCreateLabel("When Dark Elixir is Above", $x + 145, $y, -1, -1)
		$txtMaxDEAmount = GUICtrlCreateInput("200000", $x + 275, $y - 5, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetLimit(-1, 6)
	$y += 30
		$chkDESwitchMin = GUICtrlCreateCheckbox("Switch To", $x - 10, $y - 5, -1, -1)
		...
		$cmbDEMinProfile = GUICtrlCreateCombo("", $x + 60, $y - 5, 75, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			$txtTip = "Select which profile to be switched to when conditions met"
			_GUICtrlSetTip(-1, $txtTip)
		$lblDEMin = GUICtrlCreateLabel("When Dark Elixir is Below", $x + 145, $y, -1, -1)
	...
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	$y += 48
	$grpTrophySwitch = GUICtrlCreateGroup("Trophy Switch Profile Conditions", $x - 20, $y - 20, 420, 75) ; Trophy Switch
		$chkTrophySwitchMax = GUICtrlCreateCheckbox("Switch To", $x - 10, $y - 5, -1, -1)
		...
		$cmbTrophyMaxProfile = GUICtrlCreateCombo("", $x + 60, $y - 5, 75, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			$txtTip = "Select which profile to be switched to when conditions met"
			_GUICtrlSetTip(-1, $txtTip)
		$lblTrophyMax = GUICtrlCreateLabel("When Trophies are Above", $x + 145, $y, -1, -1)
		$txtMaxTrophyAmount = GUICtrlCreateInput("3000", $x + 275, $y - 5, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetLimit(-1, 4)
	$y += 30
		$chkTrophySwitchMin = GUICtrlCreateCheckbox("Switch To", $x - 10, $y - 5, -1, -1)
		...
		$cmbTrophyMinProfile = GUICtrlCreateCombo("", $x + 60, $y - 5, 75, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			$txtTip = "Select which profile to be switched to when conditions met"
			_GUICtrlSetTip(-1, $txtTip)
		$lblTrophyMin = GUICtrlCreateLabel("When Trophies are Below", $x + 145, $y, -1, -1)
